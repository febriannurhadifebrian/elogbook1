...
<head>
    ...
    <link rel="icon" href="<?= base_url('/assets/images/icon/telkomsat_icon.png') ?>" type="image/png">
...
<body class="animsition" >
    <div class="page-wrapper">
        <div class="page-content--bge5" style="background: linear-gradient(to bottom, #8B0000, #800080);
            background-size: cover;">
            <div class="container" >
                <div class="login-wrap" >
                    <div class="login-content" style="border-radius: 25px; margin-top: 40px;">
                        <?= $this->session->flashdata('message'); ?>
                        <div class="login-logo">
                            <a href="#">
                                <img src="<?= base_url('assets/') ?>images/icon/telkomsat_logo.png" width="400">
                            </a>
                        </div>
