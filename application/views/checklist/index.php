                    ...
                    <table class="table table-borderless table-data3">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($checklist as $cl) : ?>
                                <tr <?= ($cl['hp'] == 'NOK' || $cl['pc'] == 'NOK' || $cl['monitoring'] == 'NOK' || $cl['apptools'] == 'NOK' || $cl['webtools'] == 'NOK') ? 'style="background-color: #ff9999;"' : ''; ?>>
                                    <td><?= $i; ?></td>
                                    <td><h5><?= ($this->session->userdata('role_id') == 1) ? $cl['username'] : $user['username'] ?></h5></td>
                                    <td><?= date('Y-m-d / h:i A', strtotime($cl['tgl'])) ?></td>
                                    <td><?= $cl['shift'] ?></td>
                                    <td><?= $cl['care_center'] ?></td>
                                    <td class="<?= ($cl['hp'] === 'NOK' || $cl['pc'] === 'NOK' || $cl['monitoring'] === 'NOK' || $cl['apptools'] === 'NOK' || $cl['webtools'] === 'NOK') ? 'text-danger' : '' ?>">
                                        <?= ($cl['hp'] === 'NOK' || $cl['pc'] === 'NOK' || $cl['monitoring'] === 'NOK' || $cl['apptools'] === 'NOK' || $cl['webtools'] === 'NOK') ? 'NOK' : 'OK' ?>
                                    </td>
                                    <td>
                                        ...
                                        <?php if ($this->session->userdata('role_id') == 1) : ?>
                                            ...
                                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#editModal<?= $cl['id'] ?>">Edit</button>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="hp" id="hp" class="form-control">
                        ...
                        <option value="NOK"  class="text-danger" >NOK</option>
                    </select>
                </div>
                <div class="form-group">
    ...
    <div class="modal fade" id="editModal<?= $cl['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            ...
            <?= form_open_multipart("fitur/updateChecklist/{$cl['id']}", 'id="updateChecklist"'); ?>
                <div class="modal-body">
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="nip_edit" name="nip" value="<?= ($this->session->userdata('role_id') == 1) ? $cl['nip'] : $user['nip'] ?>">
                    </div>
                    <div class="row form-group">
                        <div class="col-12 col-md-14">
                            <label for="username">Username</label>
                            <input type="text" class="form-control" id="username_edit" name="username" value="<?= ($this->session->userdata('role_id') == 1) ? $cl['username'] : $user['username'] ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="tgl_edit">Tanggal</label>
                        <!-- Set nilai default dengan format yang sesuai -->
                        <input value="<?= date('Y-m-d\TH:i', strtotime($cl['tgl'])) ?>" type="datetime-local" class="form-control" id="tgl_edit" name="tgl">
                    </div>
                    <div class="form-group">
                        <label for="care_center">Care Center</label>
                    ...
                    <div class="form-group">
                        ...
                        <select name="hp" id="hp_edit" class="form-control">
                            ...
                            <option value="NOK" class="text-danger" <?= ($cl['hp'] == 'NOK') ? 'selected' : '' ?>>NOK</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="pc" id="pc_edit" class="form-control">
                            ...
                            <option value="NOK" class="text-danger" <?= ($cl['pc'] == 'NOK') ? 'selected' : '' ?>>NOK</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="monitoring" id="monitoring_edit" class="form-control">
                            ...
                            <option value="NOK" class="text-danger"<?= ($cl['monitoring'] == 'NOK') ? 'selected' : '' ?>>NOK</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="apptools" id="apptools_edit" class="form-control">
                            ...
                            <option value="NOK" class="text-danger" <?= ($cl['apptools'] == 'NOK') ? 'selected' : '' ?>>NOK</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="webtools" id="webtools_edit" class="form-control">
                            ...
                            <option value="NOK" class="text-danger"<?= ($cl['webtools'] == 'NOK') ? 'selected' : '' ?>>NOK</option>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table">
                        <tr>
                            <td>Nama:</td>
                            <td><?= ($this->session->userdata('role_id') == 1) ? $cl['username'] : $user['username'] ?></td> 
                        </tr>
                        <tr>
                            <td>Tanggal:</td>
                            <td><?= date('Y-m-d / h:i A', strtotime($cl['tgl'])) ?></td>
                        ...
                        <tr>
                            ...
                            <td class="<?= ($cl['hp'] === 'NOK') ? 'text-danger' : '' ?>"><?= $cl['hp'] ?></td>
                        </tr>
                        <tr>
                            <td>PC Operasional:</td>
                            <td class="<?= ($cl['pc'] === 'NOK') ? 'text-danger' : '' ?>"><?= $cl['pc'] ?></td>
                        </tr>
                        <tr>
                            <td>All Apps Monitoring:</td>
                            <td class="<?= ($cl['monitoring'] === 'NOK') ? 'text-danger' : '' ?>"><?= $cl['monitoring'] ?></td>
                        </tr>
                        <tr>
                            <td>All Apps Tools:</td>
                            <td class="<?= ($cl['apptools'] === 'NOK') ? 'text-danger' : '' ?>"><?= $cl['apptools'] ?></td>
                        </tr>
                        <tr>
                            <td>All Web Tools:</td>
                            <td class="<?= ($cl['webtools'] === 'NOK') ? 'text-danger' : '' ?>"><?= $cl['webtools'] ?></td>
                        </tr>
                        <tr>
                            <td>Catatan:</td>
                            <td><?= $cl['catatan']?></td>
